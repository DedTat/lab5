...
shift=300;% сдвиг отраженного модельного сигнала
...
dt_acm=dt% %оценка времени задержки по методу АКМ
dt_ma=shiftmax %оценка времени задержки по методу максимума амплитуды (МА)
